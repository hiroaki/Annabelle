...
RSpec.describe '2FA有効化フロー', type: :system do
  ...
  it '2FAを有効化できる' do
    ...
    # 右のページ、 Enableボタン押下
    click_on('users_two_factor_authentication_enable')

    secret = nil
    within('p', text: /please enter the following code manually/) do
    ...
    expect(page).to have_content('Two factor authentication has been successfully enabled')
