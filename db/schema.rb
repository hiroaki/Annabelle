...
ActiveRecord::Schema[8.1].define(version: 2025_11_27_151921) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.boolean "default_allow_location_public", default: false, null: false
    t.boolean "default_strip_metadata", default: true, null: false
    ...
    t.boolean "show_image_location_on_preview", default: true, null: false
